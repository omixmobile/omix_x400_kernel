...
#define DRIVER_VERSION			"2.0.11.0.201111"
...
#define CONFIG_PLAT_SPRD		ENABLE
#define I2C_DMA_TRANSFER		DISABLE
#define SPI_DMA_TRANSFER_SPLIT		DISABLE
#define SPRD_SYSFS_SUSPEND_RESUME	ENABLE
...
({									\
	pr_info("ILITEK_V2: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\

#define ipio_err(fmt, arg...)						\
({									\
	pr_err("ILITEK_V2: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\
...
#define TDDI_DEV_ID				"ILITEK_TDDI_V2"
...
extern int ilitek_tddi_ic_sram_test(void);
#ifdef ROI
...
extern void ilitek_tddi_dev_remove(bool);
...
extern void ilitek_tddi_interface_dev_exit(struct ilitek_tddi_dev *idev, bool flag);
