...
#define BQ2560X_REG_EN_TIMER	GENMASK(3, 3)
...
bq2560x_charger_set_termina_vol(struct bq2560x_charger_info *info, u32 vol)
{
	...
	dev_info(info->dev,"sprocomm bq2560x_charger_set_termina_vol target vol=%d, reg_val=0x%x", vol, reg_val);
				       ...
				       u32 cur)
{
	...
	dev_info(info->dev,"sprocomm bq2560x_charger_set_current target cur=%d, reg_val=0x%x", cur, reg_val);
...
static int bq2560x_charger_enable_otg(struct regulator_dev *dev)
{
	...
	dev_info(info->dev,"bq2560x_charger_enable_otg");
	/*
...
static int bq2560x_charger_vbus_is_enabled(struct regulator_dev *dev)
{
	...
	dev_info(info->dev,"bq2560x_charger_vbus_is_enabled:%d", val);
	return val;
}
...
bq2560x_charger_register_vbus_regulator(struct bq2560x_charger_info *info)
{
	...
	dev_info(info->dev,"bq2560x_charger_register_vbus_regulator");
